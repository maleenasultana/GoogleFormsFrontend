  ...
  return (
    ...
    {!emailComplete ?
      <div className="signin-container">
        ...
        <div>
          <button className="signin-page-btn">Forgot email?</button>
        </div>
        <div>
        ...
        <div>
          <button className="signin-page-btn">Create Account</button>
          <button className="next-btn" onClick={() => setEmailComplete(true)} >Next</button>
        </div>
      </div> : 
      <div className="signin-container">
        <div>
        ...
        <div className="signin-text">Welcome</div>
        <div>{user.email}</div>
        <div>
          <input
        ...
        <div className="show-pwd">
          <input type="checkbox" checked={showPwd} onChange={() => setShowPwd(!showPwd)} /> <span>Show Password</span>
        </div>
        <div>
          <p className="privacy-text">
          </p>
        ...
        <div>
          <button className="signin-page-btn">Forgot email?</button>
          <button className="next-btn" onClick={signIn}>Next</button>
        </div>
      </div>}
    </>
  );
